  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (max-width: 900px) {{
      ...
      /* Sidebar: escondida – usa o dropdown mobile */
      ...
      .mobile-menu-container {{
        ...
        border: 1.5px solid rgba(48,86,156,0.18) !important;
        border-radius: 14px !important;
        padding: 14px 16px !important;
        margin-bottom: 16px !important;
        box-shadow: 0 4px 16px rgba(48,86,156,0.08) !important;
      }}
      .mobile-menu-label {{
        display: block !important;
        font-size: 10px !important;
      ...
      .mobile-select-cia {{
        ...
        border: 1.5px solid rgba(48,86,156,0.3) !important;
        ...
        box-shadow: inset 0 1px 3px rgba(48,86,156,0.07) !important;
        appearance: none !important;
        -webkit-appearance: none !important;
        background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%2330569c' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e") !important;
      ...
      /* Scenario hero: stacked, full width */
      ...
      /* Stat boxes em grid 2 colunas para caber os valores */
      .scenario-stats {{
        width: 100% !important;
      ...
      .scenario-stats .stat-box .sv {{
        font-size: 14px !important;
        font-weight: 800 !important;
        white-space: nowrap !important;
      }}
      /* Badge +15,87% que fica absoluto – reposicionar para dentro */
      .stat-box.stat-warn > div[style*="position: absolute"] {{
        top: -8px !important;
        right: 4px !important;
      ...
      .company-info h2 {{ font-size: 17px !important; }}
      .company-info p {{ flex-wrap: wrap !important; gap: 4px !important; }}
      .company-rede-btns {{ flex-wrap: wrap !important; gap: 6px !important; }}
      .company-stats {{
        display: grid !important;
      ...
      .company-stats .stat-box .sv {{ font-size: 11px !important; font-weight: 800 !important; }}
      .company-stats .stat-box .sl {{ font-size: 8px !important; }}
      ...
      /* Summary plan cards: 1 coluna, usando flex-wrap para os itens internos */
      .summary-grid {{
      ...
      .summary-card .plan-name {{
        flex: 1 !important;
        min-width: 0 !important;
        white-space: normal !important; /* Permite que o nome quebre de linha */
        font-size: 14px !important;
        margin-bottom: 0 !important;
        line-height: 1.3 !important;
      }}
      ...
      .employees-table {{ min-width: 540px !important; }}

      /* Misc */
      .plan-cards {{ grid-template-columns: 1fr !important; gap: 12px !important; }}
      .savings-grid-layout {{ grid-template-columns: 1fr !important; gap: 10px !important; }}
      .savings-column[style*="grid-column: span 2;"] {{ grid-column: span 1 !important; }}
      .employees-header {{ flex-direction: column !important; align-items: stretch !important; gap: 10px !important; }}
...
<div class="page-wrap">
  ...
  <main class="main-content">
    ...
    <div class="mobile-menu-container">
      <span class="mobile-menu-label">Selecionar Operadora / Cenário</span>
